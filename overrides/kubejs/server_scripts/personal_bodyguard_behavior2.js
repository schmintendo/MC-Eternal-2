ItemEvents.rightClicked(event => {
    ...
    if (!server || item.id !== 'kubejs:elegant_letter') return;

    const name = player.username;

    
    player.getCooldowns().addCooldown('kubejs:elegant_letter', 9500);
    ...
    player.potionEffects.add('minecraft:glowing', 500, 0);


    const weightedEntitiess = [
        { id: 'goety_cataclysm:kobolediator', weight: 1 },
