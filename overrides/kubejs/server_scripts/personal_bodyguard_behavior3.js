ItemEvents.rightClicked(event => {
    ...
    if (!server || item.id !== 'kubejs:scorched_letter1') return;

    const name = player.username;

    
    player.getCooldowns().addCooldown('kubejs:scorched_letter1', 9500);
    ...
    const weightedEntitiess = [
        { id: 'goety_cataclysm:the_prowler', weight: 20 },
          { id: 'goety_cataclysm:watcher_servant', weight: 100 }
